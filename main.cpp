...
// IDA* SOLVER ---------------------------------------------------------------------------------------------------
    ...
    for (auto move: shuffle_moves) cout << RubiksCubeBitboard::getMove(move) << " ";
    cout << "\n";
    cube.print();

    IDAstarSolver<RubiksCubeBitboard, HashBitboard> idAstarSolver(cube);
    vector<RubiksCube::MOVE> solve_moves = idAstarSolver.solve();
    for (auto move: solve_moves) cout << RubiksCubeBitboard::getMove(move) << " ";
    cout << "\n";
...
// CornerDBMaker Testing --------------------------------------------------------------------------
 //    cout<<"Hello world";
 //    string fileName = "./Databases/data.txt";
 //
 ...
 //    cout<<"Hello world";
 //     RubiksCubeBitboard cube;
 //     auto shuffleMoves = cube.randomShuffleCube(3);
 //     cube.print();
 //    cout<<"Hello world";
